<!-- Modal Admin Edit Category -->
<div id="adminEditCategoryModal" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<!-- Modal content-->
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title"  id="modalTitle">Edit Category</h4>
			</div>
			<div class="modal-body">
				<form id="adminAddCategoryForm" method="post" action="/categories/admin_edit">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-9">								
								<button type="submit" class="btn btn-primary btn-sm" id="submitButtonAdminEditCategoryForm"><span class="glyphicon glyphicon-ok"></span> &nbsp; Save Changes</button>
							</div>
